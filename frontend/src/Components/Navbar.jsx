        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <div className={`p-7 text-gray-600 ${menu === 'shop' && 'text-red-500 border-red-500 border-b-4 '}`}>
              ...
              <div className={` p-7 ${menu === 'men' && 'border-red-500  border-b-4 '}`}>
                <Link
                  to="/mens" onClick={() => setmenu("men")}
                  className="text-gray-600 hover:text-red-500 transition-colors duration-200 font-medium"
                >
                  Men
                </Link>
              </div>
              <div className={`p-7 ${menu === 'women' && 'border-red-500 border-b-4 '}`}>
                <Link
                  to="/womens" onClick={() => setmenu("women")}
                  className="text-gray-600 hover:text-red-500 transition-colors duration-200 font-medium"
                >
                  Women
                </Link>
              </div>
              <div className={`p-7 ${menu === 'kids' && 'border-red-500 border-b-4 '}`}>
                <Link
                  to="/kids" onClick={() => setmenu("kids")}
                  className="text-gray-600 hover:text-red-500 transition-colors duration-200 font-medium"
                >
                  Kids
                </Link>
            ...
            <div className="hidden md:flex items-center space-x-6">
              <Link to="/login" className="bg-red-500 text-white px-6 py-2 rounded-full hover:bg-red-600 transition-colors duration-200 font-medium">
                Login
              </Link>
              <Link to='/cart'>
          ...
          <div className="p-6 border-t space-y-4">
            ...
            >
              <img
                ...
                className="h-6 w-6"
              />
              <span className="font-medium text-gray-700">Cart (0)</span>
            </Link>
          </div>
        </div>
      </div>
